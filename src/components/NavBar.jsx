        ...
        <div className="navigation navbar navbar-light bg-primary">
                ...
                <svg height="30" width="30" viewBox="0 0 512 511">
                    <g>
                        <path
                            ...
                            data-original="#000000" className="active-path" data-old_color="#000000" fill="#665dfe"/>
                    </g>
                </svg>
            </a>
            <ul className="nav nav-minimal flex-row flex-grow-1 justify-content-between flex-xl-column justify-content-xl-center"
                ...
                <li className="nav-item">
                    <NavLink location={location} exact activeClassName="active" className="nav-link p-0 py-xl-3" id="chats-tab" to="/chats" title="Chats">
                ...
                <li className="nav-item">
                    <NavLink location={location} exact activeClassName="active" className="nav-link p-0 py-xl-3 " id="calls-tab" to="/calls" title="Calls">
                        <svg className="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                ...
                <li className="nav-item">
                    <NavLink location={location} exact activeClassName="active" className="nav-link p-0 py-xl-3" id="friends-tab" to="/friends" title="Friends">
                        <svg className="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                ...
                <li className="nav-item">
                    <NavLink location={location} exact activeClassName="active" className="nav-link p-0 py-xl-3" id="profiles-tab" to="/profiles" title="Profile">
                        <svg className="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
