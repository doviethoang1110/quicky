...
const Modal = ({modal}) => {
    return (
        <React.Fragment>
            ...
            <div className="modal modal-lg-fullscreen fade" id="createGroup" tabIndex="-1" role="dialog"
                            ...
                            <div className="row hide pt-2" data-step="1" data-title="Create a New Group">
                                ...
                                <div className="col-12">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control form-control-md" id="groupName"
                                            ...
                                            <div className="media">
                                                ...
                                                <div className="media-options">
                                                    <div className="custom-control custom-checkbox">
                                                        <input className="custom-control-input" type="checkbox" value="" id="chx-user-1"
                                                               checked=""/>
                                                        <label className="custom-control-label" htmlFor="chx-user-1"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <label className="media-label" htmlFor="chx-user-1"></label>
                                        </li>
                                        <li className="list-group-item">
                                            <div className="media">
                                                <div className="avatar avatar-online mr-2">
                                                ...
                                                <div className="media-options">
                                                    <div className="custom-control custom-checkbox">
                                                        <input className="custom-control-input" type="checkbox" value="" id="chx-user-2"
                                                               checked=""/>
                                                        <label className="custom-control-label" htmlFor="chx-user-2"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <label className="media-label" htmlFor="chx-user-2"></label>
                                        </li>
                                        <li className="list-group-item">
                                            <div className="media">
                                                <div className="avatar avatar-offline mr-2">
                                                ...
                                                <div className="media-options">
                                                    <div className="custom-control custom-checkbox">
                                                        ...
                                                        <label className="custom-control-label" htmlFor="chx-user-3"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <label className="media-label" htmlFor="chx-user-3"></label>
                                        </li>
                                        <li className="list-group-item">
                                            <div className="media">
                                                <div className="avatar avatar-busy mr-2">
                                                ...
                                                <div className="media-options">
                                                    <div className="custom-control custom-checkbox">
                                                        <input className="custom-control-input" type="checkbox" value="" id="chx-user-4"
                                                               checked=""/>
                                                        <label className="custom-control-label" htmlFor="chx-user-4"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <label className="media-label" htmlFor="chx-user-4"></label>
                                        </li>
                                        <li className="list-group-item">
                                            <div className="media">
                                                <div className="avatar avatar-away mr-2">
                                                ...
                                                <div className="media-options">
                                                    <div className="custom-control custom-checkbox">
                                                        ...
                                                        <label className="custom-control-label" htmlFor="chx-user-5"></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <label className="media-label" htmlFor="chx-user-5"></label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="row pt-2 h-100 hide" data-step="3" data-title="Finished">
                                <div className="col-12">
                                    <div className="d-flex justify-content-center align-items-center flex-column h-100">
                                        ...
                                        <p className="text-muted text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                            Dolores cumque laborum fugiat vero pariatur provident!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="modal-footer">
                            <button type="button" className="btn btn-link text-muted js-btn-step mr-auto" data-orientation="cancel"
